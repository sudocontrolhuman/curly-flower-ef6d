...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/curly-flower-ef6d)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/curly-flower-ef6d
```

A live public deployment of this template is available at [https://curly-flower-ef6d.templates.workers.dev](https://curly-flower-ef6d.templates.workers.dev)
